...
routers = [
    ...
    (gender.router, "/genders", "Genders", [Depends(get_current_user)]),
    (level.router, "/levels", "Levels", [Depends(get_current_user)]),
    ...
    (follow_up_status.router, "/follow-up-statuses", "Follow-Up Statuses", [Depends(get_current_user)]),
